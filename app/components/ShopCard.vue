...
<template>
  <div
    class="shop-card border border-gray-100 rounded-lg bg-white cursor-pointer shadow-sm transition-transform overflow-hidden hover:scale-[1.02]"
    @click="handleClick"
  >
    <!-- Image Container -->
    <div class="relative">
      ...
      <!-- Like Button -->
      <van-button
        class="right-2 top-2 absolute !h-10 !w-10"
